package com.example.myapplication.bese;
...
public class BaseRecycleAdapter<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	 ...
	 * 		the adapter to wrap
	 */
	public BaseRecycleAdapter(T adapter) {
		super();
